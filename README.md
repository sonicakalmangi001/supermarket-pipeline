...
| [v1.3.0](https://github.com/sonicakalmangi001/supermarket-pipeline/releases/tag/v1.3.0) | ETLPipeline orchestrator, reusable ColumnStandardizer and DataQualityChecker classes, shared alias mapping, star schema alias alignment, updated tests |
